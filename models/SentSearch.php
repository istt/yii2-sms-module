...
use vendor\istt\sms\models\Sent;

/**
 * SentSearch represents the model behind the search form about `vendor\istt\Sent\models\Sent`.
 */
class SentSearch extends Sent
{
    public function rules()
    {
        return [
            ...
            [['id', 'Sent_type', 'mclass', 'mwi', 'coding', 'compress', 'validity', 'deferred', 'dlr_mask', 'pid', 'alt_dcs', 'rpi', 'campaign_id'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'momt', $this->momt])
            ...
            ->andFilterWhere(['like', 'Sentc_id', $this->smsc_id])
